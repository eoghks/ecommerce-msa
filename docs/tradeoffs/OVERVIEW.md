...
| MD-06 | 글로벌화(타임존·다국어·통화) 미적용 | 전체 서비스 + 프론트 | 한국 단일 시장 전제 — 기능이 아닌 아키텍처 변경이라 Roadmap v2.0 별도 트랙으로 계획. 타임존은 KST 명시 고정 | [MD-06-globalization-scope.md](./MD-06-globalization-scope.md) |
