...
class TossPaymentClientTest {
    ...
    @Test
    @DisplayName("취소 — paymentKey 경로에 사유·부분취소 금액을 전송한다")
    void cancel_sendsReasonAndAmount() {
        ...
        TossPaymentClient.TossPayment result =
                tossPaymentClient.cancel(PAYMENT_KEY, "반품 승인", 5_000L);
    ...
    void cancel_pgError_throwsCancelFailed() {
        ...
        assertThatThrownBy(() -> tossPaymentClient.cancel(PAYMENT_KEY, "반품 승인", 5_000L))
